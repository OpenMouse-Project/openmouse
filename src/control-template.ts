    ...
    <div class="control-shell is-empty">
      ...
      <main class="control-panel">
        ...
        <section id="pulsar-advanced" class="device-data" aria-label="Advanced device settings" style="display:none">
          ...
          <article id="teevolution-dpi-lighting" class="setting-card" data-pending-key="teevolution-dpi-light-mode teevolution-dpi-light-brightness teevolution-dpi-light-speed" hidden><div class="${CARD_HEADING}"><div><p>LIGHTING</p><h2>DPI indicator</h2></div></div><label class="${FIELD_LABEL}">Effect<select id="teevolution-dpi-light-mode"><option value="0">Off</option><option value="1">Steady</option><option value="2">Breathing</option></select></label><div class="teevolution-dpi-light-controls"><label>Brightness<output id="teevolution-dpi-light-brightness-output">5</output><input id="teevolution-dpi-light-brightness" type="range" min="1" max="10" step="1" /></label><label>Speed<output id="teevolution-dpi-light-speed-output">3</output><input id="teevolution-dpi-light-speed" type="range" min="1" max="5" step="1" /></label></div><small class="setting-note">Uses the active DPI stage colour stored by the mouse.</small></article>
