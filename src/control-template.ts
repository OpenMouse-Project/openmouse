  ...
  return `
    <div class="control-shell is-empty">
      ...
      <main class="control-panel">
        ...
        <section id="device-overview" class="device-overview device-data" data-workspace-section="overview" role="tabpanel" aria-labelledby="workspace-tab-overview" aria-label="Device status">
        ...
        <section id="logitech-onboard" class="profile-disclosure device-data" data-workspace-section="profiles" role="tabpanel" aria-labelledby="workspace-tab-profiles" hidden>
        ...
        <section id="performance-settings" class="settings-grid device-data" data-workspace-section="performance buttons" data-workspace-host role="tabpanel" aria-label="Mouse settings">
          ...
          <article id="ninjutso-settings" class="setting-card" data-pending-key="ninjutso-stage ninjutso-system ninjutso-hyper ninjutso-optical ninjutso-slam" hidden><div class="setting-heading"><div><p>NINJAFORCE</p><h2>Performance modes</h2></div></div><div id="ninjutso-stage-row" hidden><div class="setting-heading tight"><div><h2>DPI stage</h2></div></div><div id="ninjutso-stage-options" class="segmented" role="group" aria-label="DPI stage"></div></div><div id="ninjutso-system-row" hidden><div class="setting-heading tight"><div><h2>System mode</h2></div></div><div id="ninjutso-system-options" class="segmented" role="group" aria-label="System mode"></div></div><div id="ninjutso-hyper-row" hidden><div class="setting-heading tight"><div><h2>HyperClick</h2></div></div><div id="ninjutso-hyper-options" class="segmented two" role="group" aria-label="HyperClick"></div></div><div id="ninjutso-optical-row" hidden><div class="setting-heading tight"><div><h2>Optical Engine</h2></div></div><div id="ninjutso-optical-options" class="segmented two" role="group" aria-label="Optical Engine"></div></div><div id="ninjutso-slam-row" hidden><div class="setting-heading tight"><div><h2>Slam-Click</h2></div></div><div id="ninjutso-slam-options" class="segmented three" role="group" aria-label="Slam-Click"></div></div><small class="setting-note">Only controls confirmed by this mouse's firmware are shown.</small></article>
        </section>
        <section id="logitech-device-details" class="device-data" data-workspace-section="advanced" role="tabpanel" aria-labelledby="workspace-tab-advanced" style="display:none">
        ...
        <section id="logitech-analog-button-settings" class="device-data" data-workspace-section="buttons" role="tabpanel" aria-labelledby="workspace-tab-buttons" aria-label="HITS tuning settings" style="display:none">
        ...
        <section id="pulsar-advanced" class="device-data" data-workspace-section="performance buttons profiles advanced" data-workspace-host role="tabpanel" aria-label="Device settings" style="display:none">
        ...
        <aside class="testing-note" data-workspace-section="advanced" aria-label="Development testing guidance">
        ...
        <section id="device-debug-details" class="device-data" data-workspace-section="advanced" role="tabpanel" aria-labelledby="workspace-tab-advanced" aria-label="Device diagnostics">
