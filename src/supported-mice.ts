...
export const MICE: Mouse[] = [
  ...
  { brand: "Mchose",        model: "A7 V2 Pro",         status: "likely",    req: 0,
    note: "Same driver and protocol as the Ultra+; not confirmed on hardware" },
  { brand: "Mchose",        model: "A5 Pro Max (Gen 1)", status: "supported", req: 0,
    pids: [0xf019, 0xf013, 0xf015],
    note: "VID 0x2023 XVI 64-byte protocol — wired and 1K receiver paths exercised on owned hardware; 4K receiver ID recovered from the vendor model table" },
