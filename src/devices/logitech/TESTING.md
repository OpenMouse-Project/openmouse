...
onboard profile sector and are intentionally not implemented on either mouse.
Record the device identifier, protocol version, and any failing setting in the
issue or pull request. Do not use factory reset during initial testing.
