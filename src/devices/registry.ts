...
export type SupportedClient = LogitechHidppClient | PulsarClient | TeevolutionHidClient | EggOp1HidClient | EggWeHidClient | WLMouseHidClient | LamzuHidClient | OrbitalHidClient;
